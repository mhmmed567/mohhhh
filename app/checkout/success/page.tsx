      ...
      <div className="w-full max-w-lg rounded-[30px] border border-black/5 bg-white p-8 text-center shadow-sm sm:p-10">
        ...
        <p className="mt-4 leading-7 text-black/50">
          ...
          {searchParams.get("gift") === "1"
            ? "سنتواصل عبر واتساب المرسل لتأكيد الطلب والتحويل. لن نجهّز الهدية قبل التحقق من وصول المبلغ، ولن يُطلب من المستلم الدفع."
            : "سنتواصل معك عبر واتساب لإرسال المبلغ ورقم التحويل، ثم نؤكد طلبك بعد التحقق من وصول المبلغ."}
        </p>
