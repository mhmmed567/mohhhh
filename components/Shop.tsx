...
export function Shop({
  ...
  const safeProducts: Product[] = Array.isArray(products)
    ? products.filter(
        (product) =>
          product.visible !== false && product.stock !== "نفد المخزون"
      )
    : [];
  ...
  return (
    <>
      <section id="shop" dir="rtl" className="px-4 py-20 sm:px-6 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-right">
            <p className="mb-3 text-xs font-medium tracking-[0.25em] text-black/35">
              HAMMAR PERFUMES
            </p>
            <h2 className="text-3xl font-black sm:text-4xl">عطور همار</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="rounded-3xl border border-black/10 bg-white px-6 py-16 text-center">
              <p className="text-sm text-black/40">لا توجد منتجات حاليًا</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-2 lg:grid-cols-3">
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-[4/5] overflow-hidden bg-[#f7f6f2]">
                      ...
                      {onSale && (
                        <div className="absolute right-3 top-3 z-10 rounded-full bg-black px-3 py-1.5 text-[10px] font-black text-white sm:text-xs">
                          عرض
                        </div>
                      )}
                    ...
                    <div className="p-3 sm:p-5">
                      ...
                      <div className="mt-3 flex items-center justify-between gap-2">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {onSale && (
                            <p className="whitespace-nowrap text-xs text-black/35 line-through sm:text-sm">
